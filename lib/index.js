...
var OpenGraph, _, async, cheerio, iconv, request,
...
OpenGraph = (function() {
  ...
  OpenGraph.prototype.getMetaFromUrl = function(url, callback) {
    ...
    return theRequest.once('response', openGraphResponseHandler = function(res) {
      var contentDisposition, contentLength, contentType;
      ...
      if (!/text\/html/.test(contentType.toLowerCase())) {
        theRequest.abort();
  ...
  OpenGraph.prototype.getMetaFromHtml = function(html, res, callback) {
    var $, attrName, attrValue, createTree, i, len, meta, metaTags, namespace, parsed, properties, property;
    if (!callback) {
      callback = res;
    }
    parsed = {
